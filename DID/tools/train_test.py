...
def main():
    ...
    for iter in range(120, 130, 10):
        ...
        # cfg['tester']['resume_model'] = '/pvc_user/pengliang/DID/DID-main/code/log_DID_b16_UpDepthLossNet2NoBN_Flow_2/checkpoints/checkpoint_epoch_160.pth'
        # cfg['tester']['resume_model'] = '/pvc_user/pengliang/DID/DID-main/code/log_DID_b16_UpDepthLossNet2NoBN_5/checkpoints/checkpoint_epoch_200.pth'
        cfg['tester']['resume_model'] = '/pvc_user/pengliang/DID/DID-main/code/log_DID_b16_UpDepthLossNet2NoBN_Flow_test_1/checkpoints/checkpoint_epoch_140.pth'
