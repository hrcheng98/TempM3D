...
if __name__ == '__main__':
    ...
    for e in range(12, 25):
        # print('running: ', "/pvc_user/chenghaoran/tempM3D/work_dir/TIP/TIP_ctg/20231219_172304/out/EPOCH_{}/data".format(str(e*10)))
        print(e*10)
        # work_dir/TIP_try/outputs_kitti_level2_propa_factor12_Net2_1/EPOCH_200
        # eval_from_scrach(gt_dir, "/pvc_user/chenghaoran/tempM3D/work_dir/TIP/TIP_no_opflow/20231223_161826/out/EPOCH_{}/data".format(str(e*10)), ap_mode=40)
        # work_dir/TIP/TIP_ctg/20231219_172304/out
        # eval_from_scrach(gt_dir, "/pvc_user/chenghaoran/tempM3D/work_dir/TIP/TIP_ctg/20231219_172304/out/EPOCH_{}/data".format(str(e*10)), ap_mode=40)
        # /pvc_user/pengliang/DID/DID-main/code/outputs_flow_raft
        eval_from_scrach(gt_dir, "/pvc_user/chenghaoran/tempM3D/DID/work_dir/TIP/TIP_ctg_notemp/20231231_041308/outputs_flow_raft/EPOCH_{}/data".format(str(e*10)), ap_mode=40)
        # eval_from_scrach(gt_dir, "/pvc_user/chenghaoran/tempM3D/DID/work_dir/TIP/TIP_ctg/20231226_152433/outputs_flow_raft/EPOCH_{}/data".format(str(e*10)), ap_mode=40)
...
3d@0.25 [27.47245850010328, 14.297642251218324, 13.625583625409424]
    ...
    # for i in range(110, 160, 10):
        ...
        # det_dir = '/pvc_user/pengliang/GUPNet_master/GUPNet-main/code/outputs_ablation_full_1/EPOCH_{}/data'.format(i)
        # det_dir = '/pvc_user/pengliang/GUPNet_master/GUPNet-main/code/outputs_kitti_test_0530/EPOCH_{}/data'.format(i)
